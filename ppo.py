...
# python ppo.py --control_mode "pd_joint_delta_pos_left_arm" --total_timesteps 500_000
...
class Args:
    ...
    control_mode: Optional[str] = "pd_joint_delta_pos_dual_arm"
